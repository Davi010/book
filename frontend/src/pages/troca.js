...
import Modalt from "../componentes/modal-t";
import '../css/troca.css';
function Troca() {
        ...
        <div className="corpo2">
            ...
            <div className="slogan">
                ...
                <div className="unir">
                    ...
                    <div className="info">
                        <p>ESTA É A PÁGINA DESTINADA PARA VERIFICAR OS LIVROS QUE VOCÊ TEVE INTERESSE DE GUARDAR EM SUA ESTANTE.</p>
                    </div>
                </div>
            </div>
            ...
            <div className="book-troca">
                ...
                <div className="btnolhar-troca">
                    <button className="olha-troca" onClick={() => setOpenModal(true)}>DÊ UMA OLHADA</button>
                    <Modalt open={openModal} setModalOpen={() => setOpenModal(!openModal)} />
                </div>
                <div className="livros-t">
                    <div className="categoria">
                        <h2>INFANTIL</h2>
                    </div>
                    <div className="imagem">
